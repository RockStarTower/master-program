<?php
	...
	$query = "SELECT * FROM DomainDetails WHERE Type='Action Blog' AND DateComplete BETWEEN '$weekBegin' AND '$weekEnd'";
	...
	$week_ActionNumbers = mysqli_num_rows($result);
	
	echo $week_ActionNumbers;
