<?php
	...
	$query = "SELECT * FROM DomainDetails WHERE Type='Article' AND DateComplete BETWEEN '$weekBegin' AND '$weekEnd'";
	...
	$week_ArticleNumbers = mysqli_num_rows($result);
	
	echo $week_ArticleNumbers;
