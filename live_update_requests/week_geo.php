<?php
	...
	$query = "SELECT * FROM DomainDetails WHERE Type='Geo-Based' AND DateComplete BETWEEN '$weekBegin' AND '$weekEnd'";
	...
	$week_GeoNumbers = mysqli_num_rows($result);
	
	echo $week_GeoNumbers;
