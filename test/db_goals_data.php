...
define('DB_NAME', 'root');
define('DB_PASS', 'root');
define('DB_USER', 'ecoabsor_master');
...
$query = "SELECT Vertical, Country, Language, BoughtBy, DateBought, Writer, ContentFinished, Designer, DesignFinish, Developer, DevFinish, QAInspector, DateComplete, Cloner, CloneFinished FROM DomainDetails WHERE Status='" . $status . "'";
